                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php
                            $url = base_url('menu/deleteMenu/').$m['id'];
                            if($user['role_id'] == 1){
...
<div class="modal fade" id="editmenuModal<?= $r['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="editnewRoleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <form action="<?= base_url('menu/editMenu/') . $r['id']; ?>" method="post">
                <div class="modal-body">
                    <div class="form-group">
                        <label for="menu" class="form-label">Nama Menu</label>
                        <input type="text" class="form-control" id="menu" name="menu" value="<?= $r['menu'] ?>">
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
